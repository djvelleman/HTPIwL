...
You will also need the Lean package that accompanies this book, which can be downloaded from [https://github.com/djvelleman/HTPILeanPackage](https://github.com/djvelleman/HTPILeanPackage).  After following the link, click on the green "Code" button and, in the pop-up menu, select "Download ZIP".  Open the downloaded zip file to create a folder containing the HTPI Lean package.
