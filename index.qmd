...
Your installation is now complete.  In addition to the file "Blank.lean," the package contains files with all of the definitions, theorems, and exercises in the book.  There is one file for each chapter, starting with the chapter "Introduction to Lean."
