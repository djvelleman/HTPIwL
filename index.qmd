...
NOTE:  This is an incomplete draft.  This document is still under construction.
...
The files for Chapters 3--8 are inside the folder "HTPILib".  There are also two other files in that folder.  All of these files are needed to make the package work.  *Do not edit the files in the HTPILib folder*, or you will need to re-download the package.

## Acknowledgments

A number of people have provided advice, encouragement, and feedback about this project.  In particular, I would like to thank Jeremy Avigad, Clayton Cafiero, François Dorais, Charles Hoskinson, Pietro Monticone, and Ketil Wright.
