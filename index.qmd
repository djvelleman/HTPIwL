...
To open the HTPI Lean Package in Codespaces, click [here](https://codespaces.new/djvelleman/HTPILeanPackage){target="_blank"}.  (Note that Codespaces may not work in all web browsers.  If you have trouble, try switching to a different browser.)
