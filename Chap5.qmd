...
Use this definition and theorem to prove the following theorem:
...
Section 5.5 of *HTPI* introduces two new definitions.  Suppose $f : A \to B$.  If $X \subseteq A$, then the *image* of $X$ under $f$ is the set $f(X)$ defined as follows:
$$
