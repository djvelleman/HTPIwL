...
Unfortunately, there is no standard Lean tactic that does exactly the same thing as `define`.  However, you may find the tactics `dsimp` and `unfold` useful in some situations.
