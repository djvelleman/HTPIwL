...
If you have not yet opened the HTPI Lean package, either in GitHub Codespaces or in VS Code on your computer, then go back and follow the instructions in the [preface](#preface).  Once you have opened the package, click on the file Blank.lean in the list of files.  The file starts with the line `import HTPILib.HTPIDefs`.  Click on the blank line at the end of the file; this is where you will be typing your first proofs.
