...
```lean
lemma dvd_neg_iff_dvd (a b : Int) : a ∣ (-b) ↔ a ∣ b := sorry
...
::: {.numex arguments="4"}
```lean
lemma dvd_neg_iff_dvd_ex (a b : Int) : a ∣ (-b) ↔ a ∣ b := sorry
```
:::

::: {.numex arguments="5"}
```lean
--Hint:  Use Int.eq_nat_or_neg, the previous exercise, and Theorem_7_2_3.
lemma prime_dvd_nat_int {p a : Nat} {b : Int}
