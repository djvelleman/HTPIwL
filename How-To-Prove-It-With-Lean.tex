...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, breakable, interior hidden, sharp corners, frame hidden]}{\end{tcolorbox}}\fi
...
\texttt{U}, whose type is \ldots{} \texttt{Type}! So \texttt{U} can
stand for any type. You can think of the variable \texttt{U} as playing
the role of the universe of discourse, an idea that was introduced in
Section 1.3 of \emph{HTPI}. The sets \texttt{A} and \texttt{B} contain
elements from that universe of discourse, and \texttt{a} belongs to the
universe. You can prove the new version of the theorem by using exactly
the same sequence of tactics as before.
