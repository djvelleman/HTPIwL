...
The `library_search` tactic is somewhat unpredictable; sometimes it is able to find the right theorem in the library, and sometimes it isn't.  But it is always worth a try.
...
We end this section with an example of algebraic reasoning involving real numbers.  You can use the `#check` command to find the meanings of the theorems we use in this proof.
