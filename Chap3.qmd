...
### To prove a goal of the form `P → Q`: {.unnumbered}
...
::: {.lftrt}
::: {.lft}
[Tactic State Before Using Strategy]{.ul}
...
::: {.rt}
[Tactic State After Using Strategy]{.ul}
...
### To use a given of the form `P → Q`: {.unnumbered}
...
### To prove a goal of the form `¬P`: {.unnumbered}
...
### To use a given of the form `¬P`: {.unnumbered}
